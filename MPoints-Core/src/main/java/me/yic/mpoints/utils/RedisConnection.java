...
import me.yic.mpoints.data.redis.RedisSubscriber;
...
public class RedisConnection {
    ...
    public static final byte[] channelname = "MPoints_Sync".getBytes(StandardCharsets.UTF_8);
    ...
    public static boolean connectredis() {
        ...
        try {
            ...
            MPoints.getInstance().logger(null, 0,
